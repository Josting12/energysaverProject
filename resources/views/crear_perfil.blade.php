        ...
        <div class="card" style="background-color: #E5F5E0; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
            <div class="form-row" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                <div class="form-group">
                    <label for="field1" style="color: black;">Nombre de Campo:</label>
                ...
                <div class="form-group">
                    <label for="field2" style="color: black;">Nombre de Campo:</label>
                ...
                <div class="form-group">
                    <label for="field3" style="color: black;">Nombre de Campo:</label>
                ...
                <div class="form-group">
                    <label for="field4" style="color: black;">Nombre de Campo:</label>
                ...
                <div class="form-group">
                    <label for="date" style="color: black;">Nombre de Campo:</label>
